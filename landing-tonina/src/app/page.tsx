...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black text-slate-900 tracking-tight">Tonina</span>
          </div>
          <nav className="hidden md:flex gap-8 font-semibold text-slate-600">
            ...
            <a href="#caso-koala" className="hover:text-indigo-600 transition-colors">Casos Reales</a>
            <a href="#metodo" className="hover:text-indigo-600 transition-colors">El Método</a>
          </nav>
          <a
            href="https://wa.me/569XXXXXXXX?text=Hola,%20quisiera%20evaluar%20un%20proyecto%20de%20software%20con%20Tonina."
            target="_blank"
            rel="noreferrer"
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 rounded-full font-bold transition-all shadow-lg shadow-indigo-600/30"
          >
      ...
      <section className="pt-24 pb-32 px-4 sm:px-6 lg:px-8 text-center max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-slate-900 hover:bg-slate-800 text-white text-lg px-8 py-4 rounded-xl font-bold transition-all shadow-xl shadow-slate-900/20 flex items-center justify-center gap-2"
          >
          ...
          <div className="grid lg:grid-cols-2">
            <div className="p-12 md:p-16 lg:p-20 text-white flex flex-col justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-white text-indigo-900 px-6 py-3 rounded-xl font-bold w-fit hover:bg-indigo-50 transition-colors"
              >
                Ver Landing en Vivo →
              </a>
            </div>
            <div className="bg-slate-900 p-8 lg:p-12 relative flex items-center justify-center border-l border-indigo-800">
              ...
              <div className="w-full max-w-md bg-slate-100 rounded-2xl shadow-2xl overflow-hidden border border-slate-200">
                <div className="bg-white border-b border-slate-200 p-4 flex items-center gap-3">
                  ...
                  <div className="font-bold text-slate-800">Koala CRM</div>
                </div>
                <div className="p-4 flex gap-4 overflow-x-auto">
                  <div className="w-64 bg-slate-200/50 rounded-xl p-3 shrink-0">
                    ...
                    <div className="bg-white p-3 rounded-lg shadow-sm border border-slate-200 mb-2">
                      <div className="font-bold text-sm text-slate-800">Ignacio Loyola</div>
      ...
      <section id="soluciones" className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900 mb-4">¿Por qué Tonina?</h2>
      ...
      {/* Footer / CTA */}
      <footer className="bg-slate-900 text-white py-20 px-4 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="bg-indigo-600 hover:bg-indigo-500 text-white text-lg px-8 py-4 rounded-xl font-bold transition-all shadow-xl flex items-center justify-center gap-2 w-fit mx-auto"
        >
