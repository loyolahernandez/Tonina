        ...
        <div className="bg-\[#0E1330\] rounded-[2.5rem] overflow-hidden shadow-2xl">
          <div className="grid lg:grid-cols-2">
            <div className="p-12 md:p-16 lg:p-20 text-white flex flex-col justify-center">
              <span className="text-[#7A9DFF] font-bold tracking-widest uppercase mb-4 block">
                Caso de Éxito Destacado
              </span>
              <h2 className="text-4xl font-black mb-6 leading-tight">
                Jardín Infantil Koala
              </h2>
              <p className="text-lg text-[#AABCFF] mb-8 leading-relaxed">
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 text-[#C9D6FF]">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-white text-\[#0E1330\] px-6 py-3 rounded-xl font-bold w-fit hover:bg-\[#EBF0FF\] transition-colors"
              >
                Ver Landing en Vivo →
              </a>
            </div>
            <div className="bg-\[#0E1330\] p-8 lg:p-12 relative flex items-center justify-center border-l border-\[#1e2d5a\]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-2xl shadow-lg border border-slate-200 hover:-translate-y-1 transition-transform">
                <div className="w-14 h-14 bg-\[#EBF0FF\] text-\[#4976FF\] rounded-xl flex items-center justify-center mb-6">
                  {feature.icon}
                </div>
